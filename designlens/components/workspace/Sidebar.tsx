...
export function Sidebar({
  ...
  return (
    <aside className="w-60 h-screen bg-bg-surface border-r border-border flex flex-col flex-shrink-0">
      {/* Header */}
      <div className="px-4 pt-4 pb-3 flex items-center justify-between border-b border-border">
        <span className="text-[15px] font-bold tracking-tight text-text-primary">
          DesignLens
        </span>
        <div className="w-6 h-6 rounded-md bg-bg-elevated border border-border flex items-center justify-center text-[10px] text-text-secondary">
          S
        </div>
      </div>
      ...
      <div className="py-3 px-2">
        ...
        {TOOLS.map((tool) => (
          <button
            ...
            className={`w-full flex items-center gap-2 px-2 py-1.5 rounded-md text-[13px] tracking-tight transition-all cursor-pointer ${
              activeTool === tool.id
          ...
          >
            <span
              className={`w-[18px] text-center text-xs ${
      ...
      <div className="py-3 px-2">
        ...
        {projects.map((project) => (
          <button
            ...
            className={`w-full flex items-center gap-2 px-2 py-1.5 rounded-md text-[13px] transition-all cursor-pointer ${
      ...
      <div className="mt-auto p-3 border-t border-border">
        ...
        <div className="flex items-center gap-2 px-2 py-1.5 rounded-md text-xs text-text-tertiary cursor-pointer hover:bg-bg-hover hover:text-text-secondary transition-all">
          <span className="text-xs">?</span> Help & Docs
        </div>
      </div>
    </aside>
  );
